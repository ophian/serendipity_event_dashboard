...
<head>
    <!-- DASHBOARD ADMIN-ENTRY TEMPLATE: index.tpl START xxx -->
    <base target="_self"/>
    ...
    <meta name="msapplication-TileImage" content="{$CONST.DASHBOARD_PLUGINPATH}/img/ico/apple-touch-icon-144-precomposed.png">
    <meta name="msapplication-TileColor" content="#222222">

    <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,600' rel='stylesheet' type='text/css'>
    {* <link rel="stylesheet" type="text/css" href="{$admin_vars.css_file}"> disable serendipity_admin.css in dasboard mode *}
    <link rel="stylesheet" type="text/css" href="{$CONST.DASHBOARD_PLUGINPATH}/css/style.css">
    ...
    <link rel="stylesheet" href="{$CONST.DASHBOARD_PLUGINPATH}/css/fontello.css" type="text/css" media="screen">
    <link rel="stylesheet" href="{$CONST.DASHBOARD_PLUGINPATH}/css/dashboard.css" type="text/css" media="screen"> 

    <!-- Le fav and touch icons -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{$CONST.DASHBOARD_PLUGINPATH}/img/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{$CONST.DASHBOARD_PLUGINPATH}/img/ico/apple-touch-icon-114-precomposed.png">
      <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{$CONST.DASHBOARD_PLUGINPATH}/img/ico/apple-touch-icon-72-precomposed.png">
                    <link rel="apple-touch-icon-precomposed" href="{$CONST.DASHBOARD_PLUGINPATH}/img/ico/apple-touch-icon-57-precomposed.png">
                       <link rel="apple-touch-startup-image" href="{$CONST.DASHBOARD_PLUGINPATH}/img/ico/splash.png">
                                   <link rel="shortcut icon" href="{$CONST.DASHBOARD_PLUGINPATH}/img/ico/favicon.ico" type="image/x-icon">
...
{/if}
        var origintemplate     = '{$origin_template}';
        ...
        {if $admin_vars.is_logged_in}
            <nav id="user_menu">
                ...
                {if 'adminPlugins'|checkPermission}
                    <li><a id="menu-plugco" class="icon_link" href="?serendipity[adminModule]=plugins&amp;serendipity[plugin_to_conf]={$plugininstance}" title="{$sysinfo.title} Plugin [{$sysinfo.this_v}]"><span class="icon-cog"></span><span class="visuallyhidden"> {$sysinfo.title} Plugin [{$sysinfo.this_v}]</span></a></li>
                {/if}
...
{/if}
{*    <div style="" id="spinLoadProgress" class="visuallyhidden" role="status" aria-hidden="false"> *}
        <span id="loaderPanel"><img alt="" src="{$CONST.DASHBOARD_PLUGINPATH}/img/spinner.gif"></span>
{*    </div> *}

    {** include all scripts waiting for DOM ready: DOMContentLoaded-Event (document.ready) **}
    {* <script src="{$CONST.DASHBOARD_PLUGINPATH}/inc/modernizr-2.6.2.cb.min.js" defer></script> *}{* we do not need this, do we ?! *}
    <script src="{$CONST.DASHBOARD_PLUGINPATH}/inc/jquery-1.9.1.min.js" defer></script>
    <script src="{$CONST.DASHBOARD_PLUGINPATH}/inc/jquery-migrate-1.1.1.min.js" defer></script>
    <script src="{$CONST.DASHBOARD_PLUGINPATH}/inc/jquery-ui-1.10.2.min.js" defer></script>
    <script src="{$CONST.DASHBOARD_PLUGINPATH}/inc/jquery.cookie.min.js" defer></script>
    <script src="{$CONST.DASHBOARD_PLUGINPATH}/inc/jquery.simplemodal.1.4.4.min.js" defer></script>
