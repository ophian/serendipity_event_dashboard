{* function showFilters() moved into preloaded admin_container.js (admin_scripts in 2.0) *}
<!--- DASHBOARD MEDIA_PANE START -->
    ...
    <table class="serendipity_admin_filters" width="100%">
        ...
        <tr>
            <td colspan="6">
                ...
                (function() {ldelim} {if $media.keywords_selected != '' OR $show_filter}showFilters();{/if} {rdelim});
                </script>
            </td>
        </tr>
