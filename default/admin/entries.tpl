<!-- DASHBOARD ADMIN-ENTRY TEMPLATE: entries.tpl START -->
...
<table class="serendipityEntryEdit" border="0" width="100%">
    ...
    {/if}
            ...
            <script src="{$CONST.DASHBOARD_PLUGINPATH}/inc/category_selector.js"></script>
            <script type="text/javascript" language="JavaScript">
             (function() { addLoadEvent(showItem); });
            </script>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td align="right">
            {if $entry_vars.wysiwyg_advanced}
                {if $iso2br}<input type="button" class="serendipityPrettyButton input_button" name="insX" value="NoBR" accesskey="x" style="font-style: italic" onclick="wrapSelection(document.forms['serendipityEntry']['serendipity[body]'],'<nl>','</nl>')" />{/if}
            ...
            {else}
                {if $iso2br}<input type="button" class="serendipityPrettyButton input_button" value=" NoBR " onclick="serendipity_insBasic(document.forms['serendipityEntry']['serendipity[body]'], 'x')" />{/if}
    ...
    <tr>
        ...
        <td align="right">
            ...
            <div id="tools_extended" style="display: none">
                ...
                <input type="button" class="serendipityPrettyButton input_button" name="insImage" value="{$CONST.MEDIA}" style="" onclick="window.open('serendipity_admin_image_selector.php?serendipity[textarea]=extended', 'ImageSel', 'width=800,height=600,toolbar=no,scrollbars=1,scrollbars,resize=1,resizable=1');" />
    ...
    <tr>
        <td colspan="3">
            <textarea style="width: 100%; display:none;" name="serendipity[extended]" id="serendipity[extended]" cols="80" rows="20">{$entry_vars.entry.extended|@escape}</textarea>
            {if NOT $entry_vars.wysiwyg}
            <script type="text/javascript" language="JavaScript">
...
<script>
    (function(d){ 
        ...
        s.src = "serendipity_define.js.php";
