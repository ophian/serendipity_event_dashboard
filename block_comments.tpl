...
<section id="recent-comments">
    <div id="sort_{$comments_block_id}" class="dashboard dashboard_comments">
        <div class="all-box-right"> <a href="#ta_{$comments_block_id}" class="button serendipityIconLink"><button id="openall_{$comments_block_id}" class="openall"><img src="{serendipity_getFile file='img/plus.png'}" id="option_{$comments_block_id}" class="wizard-img" alt="+/-" /> Show all</button></a> </div> 
