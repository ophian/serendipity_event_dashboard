...
@define('PLUGIN_DASHBOARD_UPDATE_NOTIFIER', '<strong>Eine neue Serendipity Version ist verfügbar.</strong><br>Die neueste Version kann hier manuell heruntergeladen werden: %s');
