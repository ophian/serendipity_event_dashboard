...
@define('PLUGIN_DASHBOARD_SEQUENCE_DESC', 'Hier können sie die Reihenfolge der verschiedenen Informationsblöcke festlegen.<p>Bitte beachten Sie:</p> <p><ul><li>Entwürfe und zukünftige Artikel gehören semantisch zusammen</li><li>ebenso wie die Reihe der Core und Plugin Updates.</li><li>Diese sollten nur ineinander verschoben werden!</li><li>&nbsp;</li><li>Ansonsten wird ihr Dashboard möglicherweise nicht korrekt angeordnet.</li></ul></p>');
...
@define('UPDATE', 'Update notifier');//PLUGIN_DASHBOARD_
@define('PLUGIN_DASHBOARD_UPD', 'Core Update verfügbar');
...
@define('PLUGIN_DASHBOARD_CLEANUP_CONFIRM', 'Sollen die kompilierten Smarty Template Dateien wirklich gelöscht werden?');
