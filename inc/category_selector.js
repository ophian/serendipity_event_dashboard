...
if it is document it is window.property which is also available in short as document.property
*/
//window.onload = toggle_extended;
function toggle_extended(setCookie) {
	alert(this); // object mit inhalt null 
	...
	//if(typeof(textarea.style.display) === null) textarea.style.display = 'none';
	console.log(textarea); // object mit inhalt null 
	/*textarea = typeof textarea == 'object' ? textarea : '';
	console.log('t'+textarea + 'b'+button + 'o'+tools)*/
