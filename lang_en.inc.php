...
@define('PLUGIN_DASHBOARD_SEQUENCE_DESC', 'Here you can arrange how the different types of information shall be arranged.<p>Please be aware:</p> <p><ul><li>Draft and future entries belong semantically together,</li><li>also the Core und Plugin update row.</li><li>These should be dragged only together inline!</li><li>&nbsp;</li><li>Else your Dashboard will possibly not have the intended structure.</li></ul></p>');
...
@define('PLUGIN_DASHBOARD_UPDATE', 'Check for new available Version of Serendipity');
...
@define('PLUGIN_DASHBOARD_UPD', 'Core Update Notifier');
@define('PLUGIN_DASHBOARD_UPDATE_NOTIFIER', '<strong>A new Serendipity Version is available.</strong><br />Please consider upgrading to the newest release. You can download the new version here: ');
