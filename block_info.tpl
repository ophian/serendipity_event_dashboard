    ...
    <div id="sort_{$info_block_id}" class="dashboard dashboard_info">
        <div class="table table_content">
            ...
            <table>
                <tbody>
                <tr class="first">
                    <td class="first b b-posts"><a href="serendipity_admin.php?serendipity[adminModule]=entries&serendipity[adminAction]=editSelect"><span class="entry-count">{$infolist.total_entries}</span></a></td>
                ...
                <tr>
                    <td class="first b b-imgs"><a href="serendipity_admin.php?serendipity[adminModule]=media"><span class="img-count">{$infolist.total_imgs}</span></a></td>
                    <td class="t tags"><a href="serendipity_admin.php?serendipity[adminModule]=media">{$CONST.PLUGIN_GROUP_IMAGES}</a></td>
                </tr>
                <tr>
                    <td class="first b b-cats"><a href="serendipity_admin.php?serendipity[adminModule]=category&serendipity[adminAction]=view"><span class="cat-count">{$infolist.total_cats}</span></a></td>
                ...
                <tr>
                    <td class="first b b-tags"><a href="serendipity_admin.php?serendipity[adminModule]=event_display&serendipity[adminAction]=managetags"><span class="tag-count">{$infolist.total_tags}</span></a></td>
        ...
        <div class="table table_discussion">
            ...
            <table>
                <tbody>
                <tr class="first">
                    <td class="b b-comments"><a href="serendipity_admin.php?serendipity[adminModule]=comments"><span class="total-count">{$infolist.total_comts}</span></a></td>
                    <td class="last t comments"><a href="serendipity_admin.php?serendipity[adminModule]=comments">{$CONST.COMMENTS}</a></td>
                </tr>
                <tr>
                    <td class="b b_approved"><a href="serendipity_admin.php?serendipity[adminModule]=comments&serendipity[page]=1&serendipity[filter][perpage]=all&serendipity[filter][show]=approved&submit=go"><span class="approved-count">{$infolist.app_comts}</span></a></td>
                ...
                <tr>
                    <td class="b b-waiting"><a href="serendipity_admin.php?serendipity[adminModule]=comments&serendipity[filter][perpage]=all&serendipity[filter][show]=pending&submit=go"><span class="pending-count">{$infolist.pen_comts}</span></a></td>
                ...
                <tr>
                    <td class="b b-spam"><a href="serendipity_admin.php?serendipity[adminModule]=event_display&serendipity[adminAction]=spamblock_bayes&serendipity[subpage]=1"><span class="spam-count">{$infolist.total_spam}</span></a></td>
