{*** block_info.tpl - last modified 2013-02-12 ***}
...
<div id="info" class="block-infos block-box clearfix">
    ...
    <div id="sort_{$info_block_id}" class="block-content block-content-info clearfix">
        ...
        <div id="info-help">
            <button id="osx-modal" class="help osx" title="click 4 help" name="osx" type="button">
                <span class="icon-help-circle"></span>
                <span class="visuallyhidden"> click 4 help</span>
            </button>
        </div>

		<!-- modal content -->
		<div id="osx-modal-content">
            <div id="osx-modal-title"><u>A ruff guide to your new dashboard screen!</u></div>
            <div class="close"><a href="#" class="simplemodal-close"><span class="icon-cancel-circle"></span><span class="visuallyhidden"> Close</span></a></div>
            <div id="osx-modal-data" class="content-box guide">
			{include "./ihelp.html" cache_lifetime=86400} {*** one day: 60x60x24 ***}
